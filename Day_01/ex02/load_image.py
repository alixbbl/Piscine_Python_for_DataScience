		...
		if extension.lower() in ['.jpeg', '.jpg']:
			try:
				with Image.open(path) as img:
					img_rgb = img.convert("RGB") # on convertit l'image pixel par pixel en RGB
					image_array = np.array(img_rgb) # l'image est convertie ensuite en array
...
# On peut utiliser la fonction format() sur un nom de fichier de format str.
