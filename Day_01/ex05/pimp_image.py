...
def ft_red(array) -> np.ndarray:
    ...
    [:, :, :] qui signifie "pour toutes les dimensions de l'image", on prend les valeurs
    Vert (1) et on les multiplie par zero pour les annuler.
    Cette syntaxe est utilisée dans le cadre des arrays multidimensionnels de la lib
    NumPy.
    """
